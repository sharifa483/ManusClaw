...
- **Harassment**: Any form of harassment — discriminatory language, personal attacks, trolling, or intimidation — will result in immediate action.
- **Gatekeeping**: Everyone starts somewhere. Never mock a beginner's question, dismiss a "simple" PR, or imply someone doesn't belong here.
- **Plagiarism**: Passing off others' work as your own, or submitting code without proper attribution, is grounds for removal.
- **Malicious Contributions**: Intentionally introducing vulnerabilities, backdoors, or destructive code is an immediate and permanent ban.
- **Entitlement**: No one owes you a review, a merge, or an explanation. Contributors and maintainers volunteer their time. Respect that.
...
Violations will be addressed based on severity:
